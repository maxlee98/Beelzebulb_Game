...
cardNAME_deck <- rep(c("Wire_Left", "Wire_Right", "Wire_Up", "Wire_Down"), each = 5)
...
query_draw_cards
querytemplate <- "INSERT INTO HandCards (PlayerID, Card_ID, Card_Name) VALUES"
sql_qry <- paste0(querytemplate, paste(sprintf("(%d, %d, '%s')",
