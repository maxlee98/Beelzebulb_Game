...
=======
            ...
            fluidRow(
              column(1, img(src='Wire_Designs-01.png',width="100px",height="100px")),
              column(1, "x2"),
              column(1, img(src='Wire_Designs-02.png',width="100px",height="100px")),
              column(1, "x2"),
              column(1, img(src='Wire_Designs-03.png',width="100px",height="100px")),
              column(1, "x2"),
              column(1, img(src='Wire_Designs-04.png',width="100px",height="100px")),
              column(1, "x2"),
              column(1, img(src='Wire_Designs-05.png',width="100px",height="100px")),
              column(1, "x2")
            ),
